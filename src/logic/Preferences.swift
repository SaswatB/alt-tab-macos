...
class Preferences {
    ...
    static var windowOrder: [WindowOrderPreference] { ["windowOrder", "windowOrder2", "windowOrder3", "windowOrder4", "windowOrder5", "windowOrder6"].map { defaults.macroPref($0, WindowOrderPreference.allCases) } }
